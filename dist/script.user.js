...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#floating-list-container {
  position: fixed;
  top: 20px;
  right: 20px;
  width: 250px;
...
var App = createComponent(function () {
  return Container({
    ...
    }, 'Some Title'), createElement('button', {
      id: 'add-btn',
    ...
    }, createElement('p', {}, 'Some text'), createElement('p', {}, 'Another text'), createElement('p', {}, 'A third text'))]
  });
});
;// ./src/index.js
