...
*/
  ...
  var styles = __webpack_require__(365); // ./src/styles.css
  var options = {};
  ...
  /* harmony default export */ const src_styles =
    styles /* default */.A && styles /* default */.A.locals
      ? styles /* default */.A.locals
      : undefined; // ./src/miniFramework.js
  ...
  function _toConsumableArray(r) {
    return (
      ...
      _iterableToArray(r) ||
      container_component_unsupportedIterableToArray(r) ||
      _nonIterableSpread()
    );
  }
  ...
  function container_component_unsupportedIterableToArray(r, a) {
    if (r) {
      if ('string' == typeof r) return container_component_arrayLikeToArray(r, a);
      var t = {}.toString.call(r).slice(8, -1);
      return (
        'Object' === t && r.constructor && (t = r.constructor.name),
        'Map' === t || 'Set' === t
          ? Array.from(r)
          : 'Arguments' === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)
          ? container_component_arrayLikeToArray(r, a)
          : void 0
      );
    }
  }
  ...
  function _arrayWithoutHoles(r) {
    if (Array.isArray(r)) return container_component_arrayLikeToArray(r);
  }
  function container_component_arrayLikeToArray(r, a) {
    (null == a || a > r.length) && (a = r.length);
    for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e];
    return n;
  }
        ...
        createElement(
          'button',
          {
            ...
            onClick: function onClick() {
              return alert('Add button clicked');
            },
          },
          'Add'
        ),
